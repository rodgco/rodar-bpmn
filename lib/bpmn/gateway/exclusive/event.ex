defmodule Bpmn.Gateway.Exclusive.Event do
  @moduledoc """
  Handle passing the token through an event-based gateway element.

    iex> Bpmn.Gateway.Exclusive.Event.token_in(%{}, nil)
    {:not_implemented}
  ...
  @doc """
  Execute the event-based gateway business logic
  """
